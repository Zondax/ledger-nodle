...
__Z_INLINE parser_error_t _readMethod_balances_transfer_allow_death_V9(
    parser_context_t* c, pd_balances_transfer_allow_death_V9_t* m)
{
...
#ifndef TARGET_NANOS
__Z_INLINE parser_error_t _readMethod_polkadotxcm_teleport_assets_V9(
    parser_context_t* c, pd_polkadotxcm_teleport_assets_V9_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_polkadotxcm_limited_teleport_assets_V9(
    parser_context_t* c, pd_polkadotxcm_limited_teleport_assets_V9_t* m)
{
    CHECK_ERROR(_readBoxVersionedMultiLocation(c, &m->dest))
    CHECK_ERROR(_readBoxVersionedMultiLocation(c, &m->beneficiary))
    CHECK_ERROR(_readBoxVersionedMultiAssets(c, &m->assets))
...
__Z_INLINE parser_error_t _readMethod_polkadotxcm_force_suspension_V9(
    parser_context_t* c, pd_polkadotxcm_force_suspension_V9_t* m)
{
    CHECK_ERROR(_readbool(c, &m->suspended))
    return parser_ok;
}
__Z_INLINE parser_error_t _readMethod_xtokens_transfer_V9(
    parser_context_t* c, pd_xtokens_transfer_V9_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_xtokens_transfer_multiasset_V9(
    parser_context_t* c, pd_xtokens_transfer_multiasset_V9_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_xtokens_transfer_with_fee_V9(
    parser_context_t* c, pd_xtokens_transfer_with_fee_V9_t* m)
{
    CHECK_ERROR(_readCurrencyId(c, &m->currency_id))
    CHECK_ERROR(_readBalance(c, &m->amount))
...
__Z_INLINE parser_error_t _readMethod_xtokens_transfer_multiasset_with_fee_V9(
    parser_context_t* c, pd_xtokens_transfer_multiasset_with_fee_V9_t* m)
{
    CHECK_ERROR(_readBoxVersionedMultiAsset(c, &m->asset))
...
__Z_INLINE parser_error_t _readMethod_xtokens_transfer_multiassets_V9(
    parser_context_t* c, pd_xtokens_transfer_multiassets_V9_t* m)
{
    CHECK_ERROR(_readBoxVersionedMultiAssets(c, &m->assets))
...
__Z_INLINE parser_error_t _readMethod_balances_set_balance_deprecated_V9(
    parser_context_t* c, pd_balances_set_balance_deprecated_V9_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_balances_upgrade_accounts_V9(
    parser_context_t* c, pd_balances_upgrade_accounts_V9_t* m)
{
    CHECK_ERROR(_readVecAccountId(c, &m->who))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_balances_force_set_balance_V9(
    parser_context_t* c, pd_balances_force_set_balance_V9_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
    CHECK_ERROR(_readCompactBalance(c, &m->new_free))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_companyreserve_spend_V9(
    parser_context_t* c, pd_companyreserve_spend_V9_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_companyreserve_tip_V9(
    parser_context_t* c, pd_companyreserve_tip_V9_t* m)
{
    CHECK_ERROR(_readBalanceOf(c, &m->amount))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_companyreserve_apply_as_V9(
    parser_context_t* c, pd_companyreserve_apply_as_V9_t* m)
{
    CHECK_ERROR(_readCall(c, &m->call))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_internationalreserve_spend_V9(
    parser_context_t* c, pd_internationalreserve_spend_V9_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->to))
    CHECK_ERROR(_readBalanceOf(c, &m->amount))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_internationalreserve_tip_V9(
    parser_context_t* c, pd_internationalreserve_tip_V9_t* m)
{
    CHECK_ERROR(_readBalanceOf(c, &m->amount))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_internationalreserve_apply_as_V9(
    parser_context_t* c, pd_internationalreserve_apply_as_V9_t* m)
{
    CHECK_ERROR(_readCall(c, &m->call))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_usareserve_spend_V9(
    parser_context_t* c, pd_usareserve_spend_V9_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->to))
    CHECK_ERROR(_readBalanceOf(c, &m->amount))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_usareserve_tip_V9(
    parser_context_t* c, pd_usareserve_tip_V9_t* m)
{
    CHECK_ERROR(_readBalanceOf(c, &m->amount))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_usareserve_apply_as_V9(
    parser_context_t* c, pd_usareserve_apply_as_V9_t* m)
{
    CHECK_ERROR(_readCall(c, &m->call))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_vesting_claim_V9(
    parser_context_t* c, pd_vesting_claim_V9_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_vesting_add_vesting_schedule_V9(
    parser_context_t* c, pd_vesting_add_vesting_schedule_V9_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_vesting_cancel_all_vesting_schedules_V9(
    parser_context_t* c, pd_vesting_cancel_all_vesting_schedules_V9_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_vesting_renounce_V9(
    parser_context_t* c, pd_vesting_renounce_V9_t* m)
{
    CHECK_ERROR(_readLookupasStaticLookupSource(c, &m->who))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_mandate_apply_V9(
    parser_context_t* c, pd_mandate_apply_V9_t* m)
{
    CHECK_ERROR(_readCall(c, &m->call))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_utility_with_weight_V9(
    parser_context_t* c, pd_utility_with_weight_V9_t* m)
{
    CHECK_ERROR(_readCall(c, &m->call))
...
__Z_INLINE parser_error_t _readMethod_allocations_batch_V9(
    parser_context_t* c, pd_allocations_batch_V9_t* m)
{
    CHECK_ERROR(_readVecTupleAccountIdBalanceOf(c, &m->batch))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_allocations_set_curve_starting_block_V9(
    parser_context_t* c, pd_allocations_set_curve_starting_block_V9_t* m)
{
    CHECK_ERROR(_readBlockNumber(c, &m->curve_start))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_allocationsoracles_add_member_V9(
    parser_context_t* c, pd_allocationsoracles_add_member_V9_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_allocationsoracles_remove_member_V9(
    parser_context_t* c, pd_allocationsoracles_remove_member_V9_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_allocationsoracles_swap_member_V9(
    parser_context_t* c, pd_allocationsoracles_swap_member_V9_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->remove))
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->add))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_allocationsoracles_reset_members_V9(
    parser_context_t* c, pd_allocationsoracles_reset_members_V9_t* m)
{
    CHECK_ERROR(_readVecAccountId(c, &m->members))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_allocationsoracles_change_key_V9(
    parser_context_t* c, pd_allocationsoracles_change_key_V9_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->new_))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_allocationsoracles_set_prime_V9(
    parser_context_t* c, pd_allocationsoracles_set_prime_V9_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_allocationsoracles_clear_prime_V9(
    parser_context_t* c, pd_allocationsoracles_clear_prime_V9_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_daoreserve_spend_V9(
    parser_context_t* c, pd_daoreserve_spend_V9_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->to))
    CHECK_ERROR(_readBalanceOf(c, &m->amount))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_daoreserve_tip_V9(
    parser_context_t* c, pd_daoreserve_tip_V9_t* m)
{
    CHECK_ERROR(_readBalanceOf(c, &m->amount))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_daoreserve_apply_as_V9(
    parser_context_t* c, pd_daoreserve_apply_as_V9_t* m)
{
    CHECK_ERROR(_readCall(c, &m->call))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_contracts_call_old_weight_V9(
    parser_context_t* c, pd_contracts_call_old_weight_V9_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->dest))
    CHECK_ERROR(_readCompactBalance(c, &m->amount))
...
__Z_INLINE parser_error_t _readMethod_contracts_instantiate_with_code_old_weight_V9(
    parser_context_t* c, pd_contracts_instantiate_with_code_old_weight_V9_t* m)
{
    CHECK_ERROR(_readCompactBalance(c, &m->amount))
    CHECK_ERROR(_readCompactu64(c, &m->gas_limit))
    CHECK_ERROR(_readOptionCompactBalanceOf(c, &m->storage_deposit_limit))
...
__Z_INLINE parser_error_t _readMethod_contracts_instantiate_old_weight_V9(
    parser_context_t* c, pd_contracts_instantiate_old_weight_V9_t* m)
{
    CHECK_ERROR(_readCompactBalance(c, &m->amount))
    CHECK_ERROR(_readCompactu64(c, &m->gas_limit))
    CHECK_ERROR(_readOptionCompactBalanceOf(c, &m->storage_deposit_limit))
...
__Z_INLINE parser_error_t _readMethod_contracts_upload_code_V9(
    parser_context_t* c, pd_contracts_upload_code_V9_t* m)
{
    CHECK_ERROR(_readVecu8(c, &m->code))
    CHECK_ERROR(_readOptionCompactBalanceOf(c, &m->storage_deposit_limit))
...
__Z_INLINE parser_error_t _readMethod_contracts_remove_code_V9(
    parser_context_t* c, pd_contracts_remove_code_V9_t* m)
{
    CHECK_ERROR(_readCodeHash(c, &m->code_hash))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_contracts_set_code_V9(
    parser_context_t* c, pd_contracts_set_code_V9_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->dest))
    CHECK_ERROR(_readCodeHash(c, &m->code_hash))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_contracts_call_V9(
    parser_context_t* c, pd_contracts_call_V9_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->dest))
    CHECK_ERROR(_readCompactBalance(c, &m->amount))
...
__Z_INLINE parser_error_t _readMethod_contracts_instantiate_with_code_V9(
    parser_context_t* c, pd_contracts_instantiate_with_code_V9_t* m)
{
    CHECK_ERROR(_readCompactBalance(c, &m->amount))
    CHECK_ERROR(_readWeight(c, &m->gas_limit))
    CHECK_ERROR(_readOptionCompactBalanceOf(c, &m->storage_deposit_limit))
...
__Z_INLINE parser_error_t _readMethod_contracts_instantiate_V9(
    parser_context_t* c, pd_contracts_instantiate_V9_t* m)
{
    CHECK_ERROR(_readCompactBalance(c, &m->amount))
    CHECK_ERROR(_readWeight(c, &m->gas_limit))
    CHECK_ERROR(_readOptionCompactBalanceOf(c, &m->storage_deposit_limit))
    ...
    pd_Method_V9_t* method)
{
    ...
    case 512: /* module 2 call 0 */
        CHECK_ERROR(_readMethod_balances_transfer_allow_death_V9(c, &method->nested.balances_transfer_allow_death_V9))
        break;
    ...
    case 516: /* module 2 call 4 */
        CHECK_ERROR(_readMethod_balances_transfer_all_V9(c, &method->nested.balances_transfer_all_V9))
        break;
    ...
    case 5888: /* module 23 call 0 */
        CHECK_ERROR(_readMethod_session_set_keys_V9(c, &method->nested.session_set_keys_V9))
        break;
    case 5889: /* module 23 call 1 */
        CHECK_ERROR(_readMethod_session_purge_keys_V9(c, &method->nested.session_purge_keys_V9))
        break;
    case 10240: /* module 40 call 0 */
        CHECK_ERROR(_readMethod_utility_batch_V9(c, &method->nested.utility_batch_V9))
        break;
    case 10242: /* module 40 call 2 */
        CHECK_ERROR(_readMethod_utility_batch_all_V9(c, &method->nested.utility_batch_all_V9))
        break;
    ...
    case 8961: /* module 35 call 1 */
        CHECK_ERROR(_readMethod_polkadotxcm_teleport_assets_V9(c, &method->basic.polkadotxcm_teleport_assets_V9))
        break;
    ...
    case 8969: /* module 35 call 9 */
        CHECK_ERROR(_readMethod_polkadotxcm_limited_teleport_assets_V9(c, &method->basic.polkadotxcm_limited_teleport_assets_V9))
        break;
    case 8970: /* module 35 call 10 */
        CHECK_ERROR(_readMethod_polkadotxcm_force_suspension_V9(c, &method->basic.polkadotxcm_force_suspension_V9))
        break;
    case 9216: /* module 36 call 0 */
        CHECK_ERROR(_readMethod_xtokens_transfer_V9(c, &method->basic.xtokens_transfer_V9))
        break;
    case 9217: /* module 36 call 1 */
        CHECK_ERROR(_readMethod_xtokens_transfer_multiasset_V9(c, &method->basic.xtokens_transfer_multiasset_V9))
        break;
    case 9218: /* module 36 call 2 */
        CHECK_ERROR(_readMethod_xtokens_transfer_with_fee_V9(c, &method->basic.xtokens_transfer_with_fee_V9))
        break;
    case 9219: /* module 36 call 3 */
        CHECK_ERROR(_readMethod_xtokens_transfer_multiasset_with_fee_V9(c, &method->basic.xtokens_transfer_multiasset_with_fee_V9))
        break;
    case 9221: /* module 36 call 5 */
        CHECK_ERROR(_readMethod_xtokens_transfer_multiassets_V9(c, &method->basic.xtokens_transfer_multiassets_V9))
        break;
#endif
    ...
    case 513: /* module 2 call 1 */
        CHECK_ERROR(_readMethod_balances_set_balance_deprecated_V9(c, &method->nested.balances_set_balance_deprecated_V9))
        break;
    ...
    case 518: /* module 2 call 6 */
        CHECK_ERROR(_readMethod_balances_upgrade_accounts_V9(c, &method->basic.balances_upgrade_accounts_V9))
        break;
    case 520: /* module 2 call 8 */
        CHECK_ERROR(_readMethod_balances_force_set_balance_V9(c, &method->basic.balances_force_set_balance_V9))
        break;
    case 2816: /* module 11 call 0 */
        CHECK_ERROR(_readMethod_companyreserve_spend_V9(c, &method->basic.companyreserve_spend_V9))
        break;
    case 2817: /* module 11 call 1 */
        CHECK_ERROR(_readMethod_companyreserve_tip_V9(c, &method->basic.companyreserve_tip_V9))
        break;
    case 2818: /* module 11 call 2 */
        CHECK_ERROR(_readMethod_companyreserve_apply_as_V9(c, &method->basic.companyreserve_apply_as_V9))
        break;
    case 3072: /* module 12 call 0 */
        CHECK_ERROR(_readMethod_internationalreserve_spend_V9(c, &method->basic.internationalreserve_spend_V9))
        break;
    case 3073: /* module 12 call 1 */
        CHECK_ERROR(_readMethod_internationalreserve_tip_V9(c, &method->basic.internationalreserve_tip_V9))
        break;
    case 3074: /* module 12 call 2 */
        CHECK_ERROR(_readMethod_internationalreserve_apply_as_V9(c, &method->basic.internationalreserve_apply_as_V9))
        break;
    case 3328: /* module 13 call 0 */
        CHECK_ERROR(_readMethod_usareserve_spend_V9(c, &method->basic.usareserve_spend_V9))
        break;
    case 3329: /* module 13 call 1 */
        CHECK_ERROR(_readMethod_usareserve_tip_V9(c, &method->basic.usareserve_tip_V9))
        break;
    case 3330: /* module 13 call 2 */
        CHECK_ERROR(_readMethod_usareserve_apply_as_V9(c, &method->basic.usareserve_apply_as_V9))
        break;
    case 3584: /* module 14 call 0 */
        CHECK_ERROR(_readMethod_vesting_claim_V9(c, &method->basic.vesting_claim_V9))
        break;
    case 3585: /* module 14 call 1 */
        CHECK_ERROR(_readMethod_vesting_add_vesting_schedule_V9(c, &method->basic.vesting_add_vesting_schedule_V9))
        break;
    case 3586: /* module 14 call 2 */
        CHECK_ERROR(_readMethod_vesting_cancel_all_vesting_schedules_V9(c, &method->basic.vesting_cancel_all_vesting_schedules_V9))
        break;
    case 3587: /* module 14 call 3 */
        CHECK_ERROR(_readMethod_vesting_renounce_V9(c, &method->basic.vesting_renounce_V9))
        break;
    case 3840: /* module 15 call 0 */
        CHECK_ERROR(_readMethod_mandate_apply_V9(c, &method->nested.mandate_apply_V9))
        break;
    ...
    case 10245: /* module 40 call 5 */
        CHECK_ERROR(_readMethod_utility_with_weight_V9(c, &method->basic.utility_with_weight_V9))
        break;
    ...
    case 13056: /* module 51 call 0 */
        CHECK_ERROR(_readMethod_allocations_batch_V9(c, &method->basic.allocations_batch_V9))
        break;
    case 13057: /* module 51 call 1 */
        CHECK_ERROR(_readMethod_allocations_set_curve_starting_block_V9(c, &method->basic.allocations_set_curve_starting_block_V9))
        break;
    case 13312: /* module 52 call 0 */
        CHECK_ERROR(_readMethod_allocationsoracles_add_member_V9(c, &method->basic.allocationsoracles_add_member_V9))
        break;
    case 13313: /* module 52 call 1 */
        CHECK_ERROR(_readMethod_allocationsoracles_remove_member_V9(c, &method->basic.allocationsoracles_remove_member_V9))
        break;
    case 13314: /* module 52 call 2 */
        CHECK_ERROR(_readMethod_allocationsoracles_swap_member_V9(c, &method->basic.allocationsoracles_swap_member_V9))
        break;
    case 13315: /* module 52 call 3 */
        CHECK_ERROR(_readMethod_allocationsoracles_reset_members_V9(c, &method->basic.allocationsoracles_reset_members_V9))
        break;
    case 13316: /* module 52 call 4 */
        CHECK_ERROR(_readMethod_allocationsoracles_change_key_V9(c, &method->basic.allocationsoracles_change_key_V9))
        break;
    case 13317: /* module 52 call 5 */
        CHECK_ERROR(_readMethod_allocationsoracles_set_prime_V9(c, &method->basic.allocationsoracles_set_prime_V9))
        break;
    case 13318: /* module 52 call 6 */
        CHECK_ERROR(_readMethod_allocationsoracles_clear_prime_V9(c, &method->basic.allocationsoracles_clear_prime_V9))
        break;
    case 15360: /* module 60 call 0 */
        CHECK_ERROR(_readMethod_daoreserve_spend_V9(c, &method->basic.daoreserve_spend_V9))
        break;
    case 15361: /* module 60 call 1 */
        CHECK_ERROR(_readMethod_daoreserve_tip_V9(c, &method->basic.daoreserve_tip_V9))
        break;
    case 15362: /* module 60 call 2 */
        CHECK_ERROR(_readMethod_daoreserve_apply_as_V9(c, &method->basic.daoreserve_apply_as_V9))
        break;
    case 15872: /* module 62 call 0 */
        CHECK_ERROR(_readMethod_contracts_call_old_weight_V9(c, &method->basic.contracts_call_old_weight_V9))
        break;
    case 15873: /* module 62 call 1 */
        CHECK_ERROR(_readMethod_contracts_instantiate_with_code_old_weight_V9(c, &method->basic.contracts_instantiate_with_code_old_weight_V9))
        break;
    case 15874: /* module 62 call 2 */
        CHECK_ERROR(_readMethod_contracts_instantiate_old_weight_V9(c, &method->basic.contracts_instantiate_old_weight_V9))
        break;
    case 15875: /* module 62 call 3 */
        CHECK_ERROR(_readMethod_contracts_upload_code_V9(c, &method->basic.contracts_upload_code_V9))
        break;
    case 15876: /* module 62 call 4 */
        CHECK_ERROR(_readMethod_contracts_remove_code_V9(c, &method->basic.contracts_remove_code_V9))
        break;
    case 15877: /* module 62 call 5 */
        CHECK_ERROR(_readMethod_contracts_set_code_V9(c, &method->basic.contracts_set_code_V9))
        break;
    case 15878: /* module 62 call 6 */
        CHECK_ERROR(_readMethod_contracts_call_V9(c, &method->basic.contracts_call_V9))
        break;
    case 15879: /* module 62 call 7 */
        CHECK_ERROR(_readMethod_contracts_instantiate_with_code_V9(c, &method->basic.contracts_instantiate_with_code_V9))
        break;
    case 15880: /* module 62 call 8 */
        CHECK_ERROR(_readMethod_contracts_instantiate_V9(c, &method->basic.contracts_instantiate_V9))
        break;
#endif
    default:
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
    ...
    case 512: /* module 2 call 0 */
        switch (itemIdx) {
        case 0: /* balances_transfer_allow_death_V9 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->nested.balances_transfer_allow_death_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* balances_transfer_allow_death_V9 - amount */;
            return _toStringCompactBalance(
                &m->nested.balances_transfer_allow_death_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
    ...
    case 516: /* module 2 call 4 */
        ...
        case 0: /* balances_transfer_all_V9 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->nested.balances_transfer_all_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* balances_transfer_all_V9 - keep_alive */;
            return _toStringbool(
                &m->nested.balances_transfer_all_V9.keep_alive,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5888: /* module 23 call 0 */
        ...
        case 0: /* session_set_keys_V9 - keys */;
            return _toStringKeys(
                &m->nested.session_set_keys_V9.keys,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* session_set_keys_V9 - proof */;
            return _toStringBytes(
                &m->nested.session_set_keys_V9.proof,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10240: /* module 40 call 0 */
        ...
        case 0: /* utility_batch_V9 - calls */;
            return _toStringVecCall(
                &m->nested.utility_batch_V9.calls,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10242: /* module 40 call 2 */
        ...
        case 0: /* utility_batch_all_V9 - calls */;
            return _toStringVecCall(
                &m->nested.utility_batch_all_V9.calls,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8961: /* module 35 call 1 */
        switch (itemIdx) {
        case 0: /* polkadotxcm_teleport_assets_V9 - dest */;
            return _toStringBoxVersionedMultiLocation(
                &m->basic.polkadotxcm_teleport_assets_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* polkadotxcm_teleport_assets_V9 - beneficiary */;
            return _toStringBoxVersionedMultiLocation(
                &m->basic.polkadotxcm_teleport_assets_V9.beneficiary,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* polkadotxcm_teleport_assets_V9 - assets */;
            return _toStringBoxVersionedMultiAssets(
                &m->basic.polkadotxcm_teleport_assets_V9.assets,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* polkadotxcm_teleport_assets_V9 - fee_asset_item */;
            return _toStringu32(
                &m->basic.polkadotxcm_teleport_assets_V9.fee_asset_item,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8969: /* module 35 call 9 */
        switch (itemIdx) {
        case 0: /* polkadotxcm_limited_teleport_assets_V9 - dest */;
            return _toStringBoxVersionedMultiLocation(
                &m->basic.polkadotxcm_limited_teleport_assets_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* polkadotxcm_limited_teleport_assets_V9 - beneficiary */;
            return _toStringBoxVersionedMultiLocation(
                &m->basic.polkadotxcm_limited_teleport_assets_V9.beneficiary,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* polkadotxcm_limited_teleport_assets_V9 - assets */;
            return _toStringBoxVersionedMultiAssets(
                &m->basic.polkadotxcm_limited_teleport_assets_V9.assets,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* polkadotxcm_limited_teleport_assets_V9 - fee_asset_item */;
            return _toStringu32(
                &m->basic.polkadotxcm_limited_teleport_assets_V9.fee_asset_item,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* polkadotxcm_limited_teleport_assets_V9 - weight_limit */;
            return _toStringWeightLimit(
                &m->basic.polkadotxcm_limited_teleport_assets_V9.weight_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8970: /* module 35 call 10 */
        switch (itemIdx) {
        case 0: /* polkadotxcm_force_suspension_V9 - suspended */;
            return _toStringbool(
                &m->basic.polkadotxcm_force_suspension_V9.suspended,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9216: /* module 36 call 0 */
        switch (itemIdx) {
        case 0: /* xtokens_transfer_V9 - currency_id */;
            return _toStringCurrencyId(
                &m->basic.xtokens_transfer_V9.currency_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* xtokens_transfer_V9 - amount */;
            return _toStringBalance(
                &m->basic.xtokens_transfer_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* xtokens_transfer_V9 - dest */;
            return _toStringBoxVersionedMultiLocation(
                &m->basic.xtokens_transfer_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* xtokens_transfer_V9 - dest_weight_limit */;
            return _toStringWeightLimit(
                &m->basic.xtokens_transfer_V9.dest_weight_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9217: /* module 36 call 1 */
        switch (itemIdx) {
        case 0: /* xtokens_transfer_multiasset_V9 - asset */;
            return _toStringBoxVersionedMultiAsset(
                &m->basic.xtokens_transfer_multiasset_V9.asset,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* xtokens_transfer_multiasset_V9 - dest */;
            return _toStringBoxVersionedMultiLocation(
                &m->basic.xtokens_transfer_multiasset_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* xtokens_transfer_multiasset_V9 - dest_weight_limit */;
            return _toStringWeightLimit(
                &m->basic.xtokens_transfer_multiasset_V9.dest_weight_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9218: /* module 36 call 2 */
        switch (itemIdx) {
        case 0: /* xtokens_transfer_with_fee_V9 - currency_id */;
            return _toStringCurrencyId(
                &m->basic.xtokens_transfer_with_fee_V9.currency_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* xtokens_transfer_with_fee_V9 - amount */;
            return _toStringBalance(
                &m->basic.xtokens_transfer_with_fee_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* xtokens_transfer_with_fee_V9 - fee */;
            return _toStringBalance(
                &m->basic.xtokens_transfer_with_fee_V9.fee,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* xtokens_transfer_with_fee_V9 - dest */;
            return _toStringBoxVersionedMultiLocation(
                &m->basic.xtokens_transfer_with_fee_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* xtokens_transfer_with_fee_V9 - dest_weight_limit */;
            return _toStringWeightLimit(
                &m->basic.xtokens_transfer_with_fee_V9.dest_weight_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9219: /* module 36 call 3 */
        switch (itemIdx) {
        case 0: /* xtokens_transfer_multiasset_with_fee_V9 - asset */;
            return _toStringBoxVersionedMultiAsset(
                &m->basic.xtokens_transfer_multiasset_with_fee_V9.asset,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* xtokens_transfer_multiasset_with_fee_V9 - fee */;
            return _toStringBoxVersionedMultiAsset(
                &m->basic.xtokens_transfer_multiasset_with_fee_V9.fee,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* xtokens_transfer_multiasset_with_fee_V9 - dest */;
            return _toStringBoxVersionedMultiLocation(
                &m->basic.xtokens_transfer_multiasset_with_fee_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* xtokens_transfer_multiasset_with_fee_V9 - dest_weight_limit */;
            return _toStringWeightLimit(
                &m->basic.xtokens_transfer_multiasset_with_fee_V9.dest_weight_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9221: /* module 36 call 5 */
        switch (itemIdx) {
        case 0: /* xtokens_transfer_multiassets_V9 - assets */;
            return _toStringBoxVersionedMultiAssets(
                &m->basic.xtokens_transfer_multiassets_V9.assets,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* xtokens_transfer_multiassets_V9 - fee_item */;
            return _toStringu32(
                &m->basic.xtokens_transfer_multiassets_V9.fee_item,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* xtokens_transfer_multiassets_V9 - dest */;
            return _toStringBoxVersionedMultiLocation(
                &m->basic.xtokens_transfer_multiassets_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* xtokens_transfer_multiassets_V9 - dest_weight_limit */;
            return _toStringWeightLimit(
                &m->basic.xtokens_transfer_multiassets_V9.dest_weight_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 513: /* module 2 call 1 */
        switch (itemIdx) {
        case 0: /* balances_set_balance_deprecated_V9 - who */;
            return _toStringAccountIdLookupOfT(
                &m->nested.balances_set_balance_deprecated_V9.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* balances_set_balance_deprecated_V9 - new_free */;
            return _toStringCompactBalance(
                &m->nested.balances_set_balance_deprecated_V9.new_free,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* balances_set_balance_deprecated_V9 - old_reserved */;
            return _toStringCompactBalance(
                &m->nested.balances_set_balance_deprecated_V9.old_reserved,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 518: /* module 2 call 6 */
        switch (itemIdx) {
        case 0: /* balances_upgrade_accounts_V9 - who */;
            return _toStringVecAccountId(
                &m->basic.balances_upgrade_accounts_V9.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 520: /* module 2 call 8 */
        switch (itemIdx) {
        case 0: /* balances_force_set_balance_V9 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.balances_force_set_balance_V9.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* balances_force_set_balance_V9 - new_free */;
            return _toStringCompactBalance(
                &m->basic.balances_force_set_balance_V9.new_free,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2816: /* module 11 call 0 */
        switch (itemIdx) {
        case 0: /* companyreserve_spend_V9 - to */;
            return _toStringAccountId(
                &m->basic.companyreserve_spend_V9.to,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* companyreserve_spend_V9 - amount */;
            return _toStringBalanceOf(
                &m->basic.companyreserve_spend_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2817: /* module 11 call 1 */
        switch (itemIdx) {
        case 0: /* companyreserve_tip_V9 - amount */;
            return _toStringBalanceOf(
                &m->basic.companyreserve_tip_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2818: /* module 11 call 2 */
        switch (itemIdx) {
        case 0: /* companyreserve_apply_as_V9 - call */;
            return _toStringCall(
                &m->basic.companyreserve_apply_as_V9.call,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3072: /* module 12 call 0 */
        switch (itemIdx) {
        case 0: /* internationalreserve_spend_V9 - to */;
            return _toStringAccountId(
                &m->basic.internationalreserve_spend_V9.to,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* internationalreserve_spend_V9 - amount */;
            return _toStringBalanceOf(
                &m->basic.internationalreserve_spend_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3073: /* module 12 call 1 */
        switch (itemIdx) {
        case 0: /* internationalreserve_tip_V9 - amount */;
            return _toStringBalanceOf(
                &m->basic.internationalreserve_tip_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3074: /* module 12 call 2 */
        switch (itemIdx) {
        case 0: /* internationalreserve_apply_as_V9 - call */;
            return _toStringCall(
                &m->basic.internationalreserve_apply_as_V9.call,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3328: /* module 13 call 0 */
        switch (itemIdx) {
        case 0: /* usareserve_spend_V9 - to */;
            return _toStringAccountId(
                &m->basic.usareserve_spend_V9.to,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* usareserve_spend_V9 - amount */;
            return _toStringBalanceOf(
                &m->basic.usareserve_spend_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3329: /* module 13 call 1 */
        switch (itemIdx) {
        case 0: /* usareserve_tip_V9 - amount */;
            return _toStringBalanceOf(
                &m->basic.usareserve_tip_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3330: /* module 13 call 2 */
        switch (itemIdx) {
        case 0: /* usareserve_apply_as_V9 - call */;
            return _toStringCall(
                &m->basic.usareserve_apply_as_V9.call,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3585: /* module 14 call 1 */
        switch (itemIdx) {
        case 0: /* vesting_add_vesting_schedule_V9 - dest */;
            return _toStringLookupasStaticLookupSource(
                &m->basic.vesting_add_vesting_schedule_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* vesting_add_vesting_schedule_V9 - schedule */;
            return _toStringVestingScheduleOf(
                &m->basic.vesting_add_vesting_schedule_V9.schedule,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3586: /* module 14 call 2 */
        switch (itemIdx) {
        case 0: /* vesting_cancel_all_vesting_schedules_V9 - who */;
            return _toStringLookupasStaticLookupSource(
                &m->basic.vesting_cancel_all_vesting_schedules_V9.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* vesting_cancel_all_vesting_schedules_V9 - funds_collector */;
            return _toStringLookupasStaticLookupSource(
                &m->basic.vesting_cancel_all_vesting_schedules_V9.funds_collector,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3587: /* module 14 call 3 */
        switch (itemIdx) {
        case 0: /* vesting_renounce_V9 - who */;
            return _toStringLookupasStaticLookupSource(
                &m->basic.vesting_renounce_V9.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3840: /* module 15 call 0 */
        switch (itemIdx) {
        case 0: /* mandate_apply_V9 - call */;
            return _toStringCall(
                &m->nested.mandate_apply_V9.call,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10245: /* module 40 call 5 */
        switch (itemIdx) {
        case 0: /* utility_with_weight_V9 - call */;
            return _toStringCall(
                &m->basic.utility_with_weight_V9.call,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* utility_with_weight_V9 - weight */;
            return _toStringWeight(
                &m->basic.utility_with_weight_V9.weight,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13056: /* module 51 call 0 */
        switch (itemIdx) {
        case 0: /* allocations_batch_V9 - batch */;
            return _toStringVecTupleAccountIdBalanceOf(
                &m->basic.allocations_batch_V9.batch,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13057: /* module 51 call 1 */
        switch (itemIdx) {
        case 0: /* allocations_set_curve_starting_block_V9 - curve_start */;
            return _toStringBlockNumber(
                &m->basic.allocations_set_curve_starting_block_V9.curve_start,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13312: /* module 52 call 0 */
        switch (itemIdx) {
        case 0: /* allocationsoracles_add_member_V9 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.allocationsoracles_add_member_V9.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13313: /* module 52 call 1 */
        switch (itemIdx) {
        case 0: /* allocationsoracles_remove_member_V9 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.allocationsoracles_remove_member_V9.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13314: /* module 52 call 2 */
        switch (itemIdx) {
        case 0: /* allocationsoracles_swap_member_V9 - remove */;
            return _toStringAccountIdLookupOfT(
                &m->basic.allocationsoracles_swap_member_V9.remove,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* allocationsoracles_swap_member_V9 - add */;
            return _toStringAccountIdLookupOfT(
                &m->basic.allocationsoracles_swap_member_V9.add,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13315: /* module 52 call 3 */
        switch (itemIdx) {
        case 0: /* allocationsoracles_reset_members_V9 - members */;
            return _toStringVecAccountId(
                &m->basic.allocationsoracles_reset_members_V9.members,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13316: /* module 52 call 4 */
        switch (itemIdx) {
        case 0: /* allocationsoracles_change_key_V9 - new_ */;
            return _toStringAccountIdLookupOfT(
                &m->basic.allocationsoracles_change_key_V9.new_,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13317: /* module 52 call 5 */
        switch (itemIdx) {
        case 0: /* allocationsoracles_set_prime_V9 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.allocationsoracles_set_prime_V9.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 15360: /* module 60 call 0 */
        switch (itemIdx) {
        case 0: /* daoreserve_spend_V9 - to */;
            return _toStringAccountId(
                &m->basic.daoreserve_spend_V9.to,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* daoreserve_spend_V9 - amount */;
            return _toStringBalanceOf(
                &m->basic.daoreserve_spend_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 15361: /* module 60 call 1 */
        switch (itemIdx) {
        case 0: /* daoreserve_tip_V9 - amount */;
            return _toStringBalanceOf(
                &m->basic.daoreserve_tip_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 15362: /* module 60 call 2 */
        switch (itemIdx) {
        case 0: /* daoreserve_apply_as_V9 - call */;
            return _toStringCall(
                &m->basic.daoreserve_apply_as_V9.call,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 15872: /* module 62 call 0 */
        switch (itemIdx) {
        case 0: /* contracts_call_old_weight_V9 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->basic.contracts_call_old_weight_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_call_old_weight_V9 - amount */;
            return _toStringCompactBalance(
                &m->basic.contracts_call_old_weight_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_call_old_weight_V9 - gas_limit */;
            return _toStringCompactu64(
                &m->basic.contracts_call_old_weight_V9.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* contracts_call_old_weight_V9 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->basic.contracts_call_old_weight_V9.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* contracts_call_old_weight_V9 - data */;
            return _toStringVecu8(
                &m->basic.contracts_call_old_weight_V9.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 15873: /* module 62 call 1 */
        switch (itemIdx) {
        case 0: /* contracts_instantiate_with_code_old_weight_V9 - amount */;
            return _toStringCompactBalance(
                &m->basic.contracts_instantiate_with_code_old_weight_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_instantiate_with_code_old_weight_V9 - gas_limit */;
            return _toStringCompactu64(
                &m->basic.contracts_instantiate_with_code_old_weight_V9.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_instantiate_with_code_old_weight_V9 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->basic.contracts_instantiate_with_code_old_weight_V9.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* contracts_instantiate_with_code_old_weight_V9 - code */;
            return _toStringVecu8(
                &m->basic.contracts_instantiate_with_code_old_weight_V9.code,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* contracts_instantiate_with_code_old_weight_V9 - data */;
            return _toStringVecu8(
                &m->basic.contracts_instantiate_with_code_old_weight_V9.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* contracts_instantiate_with_code_old_weight_V9 - salt */;
            return _toStringVecu8(
                &m->basic.contracts_instantiate_with_code_old_weight_V9.salt,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 15874: /* module 62 call 2 */
        switch (itemIdx) {
        case 0: /* contracts_instantiate_old_weight_V9 - amount */;
            return _toStringCompactBalance(
                &m->basic.contracts_instantiate_old_weight_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_instantiate_old_weight_V9 - gas_limit */;
            return _toStringCompactu64(
                &m->basic.contracts_instantiate_old_weight_V9.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_instantiate_old_weight_V9 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->basic.contracts_instantiate_old_weight_V9.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* contracts_instantiate_old_weight_V9 - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_instantiate_old_weight_V9.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* contracts_instantiate_old_weight_V9 - data */;
            return _toStringVecu8(
                &m->basic.contracts_instantiate_old_weight_V9.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* contracts_instantiate_old_weight_V9 - salt */;
            return _toStringVecu8(
                &m->basic.contracts_instantiate_old_weight_V9.salt,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 15875: /* module 62 call 3 */
        switch (itemIdx) {
        case 0: /* contracts_upload_code_V9 - code */;
            return _toStringVecu8(
                &m->basic.contracts_upload_code_V9.code,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_upload_code_V9 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->basic.contracts_upload_code_V9.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_upload_code_V9 - determinism */;
            return _toStringDeterminism(
                &m->basic.contracts_upload_code_V9.determinism,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 15876: /* module 62 call 4 */
        switch (itemIdx) {
        case 0: /* contracts_remove_code_V9 - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_remove_code_V9.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 15877: /* module 62 call 5 */
        switch (itemIdx) {
        case 0: /* contracts_set_code_V9 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->basic.contracts_set_code_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_set_code_V9 - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_set_code_V9.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 15878: /* module 62 call 6 */
        switch (itemIdx) {
        case 0: /* contracts_call_V9 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->basic.contracts_call_V9.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_call_V9 - amount */;
            return _toStringCompactBalance(
                &m->basic.contracts_call_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_call_V9 - gas_limit */;
            return _toStringWeight(
                &m->basic.contracts_call_V9.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* contracts_call_V9 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->basic.contracts_call_V9.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* contracts_call_V9 - data */;
            return _toStringVecu8(
                &m->basic.contracts_call_V9.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 15879: /* module 62 call 7 */
        switch (itemIdx) {
        case 0: /* contracts_instantiate_with_code_V9 - amount */;
            return _toStringCompactBalance(
                &m->basic.contracts_instantiate_with_code_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_instantiate_with_code_V9 - gas_limit */;
            return _toStringWeight(
                &m->basic.contracts_instantiate_with_code_V9.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_instantiate_with_code_V9 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->basic.contracts_instantiate_with_code_V9.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* contracts_instantiate_with_code_V9 - code */;
            return _toStringVecu8(
                &m->basic.contracts_instantiate_with_code_V9.code,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* contracts_instantiate_with_code_V9 - data */;
            return _toStringVecu8(
                &m->basic.contracts_instantiate_with_code_V9.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* contracts_instantiate_with_code_V9 - salt */;
            return _toStringVecu8(
                &m->basic.contracts_instantiate_with_code_V9.salt,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 15880: /* module 62 call 8 */
        switch (itemIdx) {
        case 0: /* contracts_instantiate_V9 - amount */;
            return _toStringCompactBalance(
                &m->basic.contracts_instantiate_V9.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_instantiate_V9 - gas_limit */;
            return _toStringWeight(
                &m->basic.contracts_instantiate_V9.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_instantiate_V9 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->basic.contracts_instantiate_V9.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* contracts_instantiate_V9 - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_instantiate_V9.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* contracts_instantiate_V9 - data */;
            return _toStringBytes(
                &m->basic.contracts_instantiate_V9.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* contracts_instantiate_V9 - salt */;
            return _toStringBytes(
                &m->basic.contracts_instantiate_V9.salt,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
...
bool _getMethod_ItemIsExpert_V9(uint8_t moduleIdx, uint8_t callIdx, __Z_UNUSED uint8_t itemIdx)
{
    uint16_t callPrivIdx = ((uint16_t)moduleIdx << 8u) + callIdx;
